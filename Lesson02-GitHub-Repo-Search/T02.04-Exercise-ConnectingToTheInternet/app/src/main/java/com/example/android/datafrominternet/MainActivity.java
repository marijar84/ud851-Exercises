...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        try{
            String sGetResponseFromHttpUrl = NetworkUtils.getResponseFromHttpUrl(githubSearchUrl);
            mSearchResultsTextView.setText(sGetResponseFromHttpUrl);
        }
        catch (IOException ieIOException){
            ieIOException.printStackTrace();
        }
